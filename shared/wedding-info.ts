...
export const weddingFaqs: readonly WeddingFaqItem[] = [
  ...
  },
  {
    ...
    answer:
      "Light snacks will be offered at cocktail hour, followed by a buffet-style dinner at 6:30 PM.",
  },
  {
    question: "Will there be parking available?",
    answer:
      "Yes, free street parking and nearby lots are available, and there will be an officer directing traffic. You can also use Uber or MARTA if you're feeling adventurous!",
  },
  {
    question: "What if I have dietary restrictions?",
    answer:
      "Please fill out the RSVP form to notify us of any dietary restrictions as soon as possible for us to request separate food accommodations.",
  },
  {
